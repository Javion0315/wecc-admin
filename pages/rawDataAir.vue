				...
				<table class="min-w-full table-auto border-collapse text-sm" v-else>
					...
					<thead>
						<tr class="bg-gray-400 text-white text-left">
							...
							<th class="w-36 min-w-[100px] py-2 px-3">valueCo</th>
							<th class="w-36 min-w-[100px] py-2 px-3">valueCo2</th>
							<th class="w-36 min-w-[100px] py-2 px-3">valueFungi</th>
							<th class="w-36 min-w-[100px] py-2 px-3">valueHcho</th>
							<th class="w-36 min-w-[100px] py-2 px-3">valueHumidity</th>
							<th class="w-36 min-w-[100px] py-2 px-3">valueIqa</th>
							<th class="w-36 min-w-[100px] py-2 px-3">valueMold</th>
							<th class="w-36 min-w-[100px] py-2 px-3">valueO3</th>
							<th class="w-36 min-w-[100px] py-2 px-3">valuePm1</th>
							<th class="w-36 min-w-[100px] py-2 px-3">valuePm2Dot5</th>
							<th class="w-36 min-w-[100px] py-2 px-3">valuePm10</th>
							<th class="w-36 min-w-[100px] py-2 px-3">valueTemperature</th>
							<th class="w-36 min-w-[100px] py-2 px-3">valueTvoc</th>
					...
					<tbody>
						...
						>
							...
							<th class="w-36 min-w-[100px] py-2 px-3">{{ item.valueCo }}</th>
							<th class="w-36 min-w-[100px] py-2 px-3">{{ item.valueCo2 }}</th>
							<th class="w-36 min-w-[100px] py-2 px-3">
								{{ item.valueFungi }}
							</th>
							<th class="w-36 min-w-[100px] py-2 px-3">{{ item.valueHcho }}</th>
							<th class="w-36 min-w-[100px] py-2 px-3">
								{{ item.valueHumidity }}
							</th>
							<th class="w-36 min-w-[100px] py-2 px-3">{{ item.valueIqa }}</th>
							<th class="w-36 min-w-[100px] py-2 px-3">{{ item.valueMold }}</th>
							<th class="w-36 min-w-[100px] py-2 px-3">{{ item.valueO3 }}</th>
							<th class="w-36 min-w-[100px] py-2 px-3">{{ item.valuePm1 }}</th>
							<th class="w-36 min-w-[100px] py-2 px-3">
								{{ item.valuePm2Dot5 }}
							</th>
							<th class="w-36 min-w-[100px] py-2 px-3">{{ item.valuePm10 }}</th>
							<th class="w-36 min-w-[100px] py-2 px-3">
								{{ item.valueTemperature }}
							</th>
							<th class="w-36 min-w-[100px] py-2 px-3">{{ item.valueTvoc }}</th>
...
<script>
import { getAdminRawDataAir } from "@/api/rawData";
...
export default {
	...
	methods: {
		getData() {
			...
			getAdminRawDataAir(payLoad)
				.then((res) => {
					this.rawList = res.data.dataAir;
